...
var GithubCorners = function (props) {
    var _a = props.size, size = _a === void 0 ? 80 : _a, _b = props.fixed, fixed = _b === void 0 ? false : _b, bottom = props.bottom, zIndex = props.zIndex; props.className; var style = props.style, _c = props.bgColor, bgColor = _c === void 0 ? '#151513' : _c, _d = props.color, color = _d === void 0 ? '#fff' : _d, _e = props.position, position = _e === void 0 ? 'right' : _e, otherProps = __rest(props, ["size", "fixed", "bottom", "zIndex", "className", "style", "bgColor", "color", "position"]);
    var styl = position === 'left'
        ? { left: 0, right: 'initial', transform: 'scale(-1, 1)' }
        : { right: 0, left: 'initial', transform: 'scale(1, 1)' };
    if (bottom) {
        styl.bottom = 0;
        styl.top = 'initial';
